...
export type Replacer = ((this: Record<string | number, any>, key: string | number, value: any) => any) | string[] | null | undefined
let rep: Replacer
...
function str(key: string | number, holder: Record<string | number, any>): string {
  ...
  let length: number
  const mind = gap
  let partial: string[] // The array holding the partial texts.
